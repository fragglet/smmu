...
{
  {"320x200",               false,  1},
  {"320x200 2x stretch",    false,  2},
  {"320x200 3x stretch",    false,  3},
  {"320x200 4x stretch",    false,  4},
  {"640x400",               true,   1},
  {"640x400 2x stretch",    true,   2},
  {NULL},
};

void I_SetMode(int i)
{
  I_InitGraphics();         // make sure we are connected to X server
  I_CloseWindow();          // close window if we have one open

  multiply = videomodes[i].multiply;
